...
class myappbase_fhtab_subject_view(models.Model):
    _name = "myappbase.fhtab_subject_view"
    _description = "科目"
    _auto = False
    ...
    parent_id=fields.Many2one('myappbase.fhtab_subject_view',u'上级科目',readonly=False,required=False,translate=False)
    ...
    def name_get(self):
        ...
        return super(myappbase_fhtab_subject_view, self).name_get()
    ...
    def init(self):
        ...
        self.env.cr.execute("""CREATE or REPLACE VIEW %s as (
                   SELECT 10000+s."id" as "id",
                    ...
                    l."fhmajor" as "fhmajor"  FROM mybase_fhtab_subject as l  
                    GROUP BY "id"					
            )""" % (self._table))
