  ...
  <Card>     
      ...
      <tbody>
          ...
          <tr>
                  <td colSpan={4}>
                      <div className="p-field p-col-12 p-md-12">
                      <label htmlFor="firstname1">{t("opportunityComments.mid")}</label>
                      <div style={{height:10}}> </div>
                      <InputNumber 
                      id="mid"
                      value={mid}
          ...
          <tr>
                <td colSpan={4}>
                    <div className="p-field p-col-12 p-md-12">
                    <label htmlFor="firstname1">{t("opportunityComments.subject")}</label>
                    <div style={{height:10}}> </div>
                    <InputText 
                    id="subject"
                    value={subject}
          ...
          <tr>
                  <td colSpan={4}>
                      <div className="p-field p-col-12 p-md-12">
                      <label htmlFor="firstname1">{t("opportunityComments.assignTo")}</label>
                      <div style={{height:10}}> </div>
                      <MultiSelect 
                      id="assignTo"
                      value={assignTo}
          ...
          <tr>
                <td colSpan={4}>
                    <div className="p-field p-col-12 p-md-12">
                    <label htmlFor="firstname1">{t("opportunityComments.note")}</label>
                    <div style={{height:10}}> </div>
                    <InputTextarea 
                    id="note"
                    value={note}
